...
class Check:
	# اگر فاصله بین هر المان فورگراند یا بک گراند بیشتر از 10 باشه ۱ ریترن میشه به عنوان فاصله زیاد و تایید. در غیر این صو.رتت 0 ریتترن میشه به معنای فاصله کم و غیر قابل تایید
